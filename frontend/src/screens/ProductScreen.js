...
} from '../features/products/productCreateReview/productCreateReviewSlice';
import {
  Row,
  Col,
  Image,
...
const ProductScreen = () => {
  ...
  useEffect(() => {
    ...
    dispatch(getProductDetailStart({ id: params.id }));
  }, [dispatch, params.id, successProductReview, navigate]);
